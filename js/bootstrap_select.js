...
jQuery(function($){
        ...
        function attach(i, e) {
                if (!($(e).data('convert') == 'no')) {
                        ...
                        select.html('<input type="hidden" value="' + $(e).val() + '" name="' + $(e).attr('name') + '" id="' + $(e).attr('id') + '" class="' + $(e).attr('class') + '" /><a class="btn dropdown-toggle" data-toggle="dropdown" href="javascript:;">' + current + '&nbsp;&nbsp;<span class="caret"></span></a><ul class="dropdown-menu"></ul>');
